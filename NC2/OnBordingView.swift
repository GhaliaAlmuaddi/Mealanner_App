                            ...
                            TabView(selection: $current) {
                                ForEach(0..<onBording_set.count, id: \.self) { item in
                                    VStack {
                                        ...
                                        Text(onBording_set[item].Title).font(/*@START_MENU_TOKEN@*/.title/*@END_MENU_TOKEN@*/).bold().padding(.top, current == 0 ? -30 : 0)
                                        
                                        Text(onBording_set[item].description).multilineTextAlignment(.center).padding(.horizontal, 32).padding(.top, 5)
                                    }.tag(item)
                                }
